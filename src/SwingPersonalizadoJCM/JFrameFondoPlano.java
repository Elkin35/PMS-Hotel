...
public class JFrameFondoPlano extends JFrame {
	 ...
	 * 
	 * */
	public JFrameFondoPlano(String Title, Color color) {
	 ...
	 * 
	 * */
	public JFrameFondoPlano(String Title, Color color, int width, int height ) {
	 ...
	 * Set the size to the screen size
	 * 
	 * @param permanent if true setResizzable value turns false and it kept the full size of the window 
	 * 
	 * */
	...
	/*
	 * 
	 * Create a centered JPanel in the midle of the JFrame
	 * 
