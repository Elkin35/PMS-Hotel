...
public class HabitacionSuiteDoble extends Habitacion {
	public HabitacionSuiteDoble(int identificador, String ubicacion, int capacidad, int tamanio, int voltaje, boolean balcon, boolean vista,
